...
const initialInventory = [
  {
    ...
    unit: 'kg',
    costPerUnit: 3.00,
    supplier: 'Colombo Grains Ltd.',
    lastRestocked: '2024-01-12',
    status: 'low',
    description: 'High-quality wheat flour for Colombo bakery products'
  },
  {
    id: 2,
    name: 'Salted Butter',
    ...
    unit: 'kg',
    costPerUnit: 7.00,
    supplier: 'Butter House Colombo',
    lastRestocked: '2024-01-14',
    status: 'low',
    description: 'Salted butter for baking and pastries'
  },
  {
    id: 3,
    name: 'Baking Soda',
    ...
    unit: 'boxes',
    costPerUnit: 2.80,
    supplier: 'Colombo Baking Supplies',
    lastRestocked: '2024-01-10',
    status: 'critical',
    description: 'Baking soda for cakes and cookies'
  },
  {
    id: 4,
    ...
    unit: 'kg',
    costPerUnit: 2.00,
    supplier: 'Sweet Lanka Co.',
    lastRestocked: '2024-01-15',
    status: 'good',
    description: 'Fine granulated sugar for all bakery needs'
  },
  {
    id: 5,
    ...
    status: 'low',
    description: 'Medium-sized cake boxes for Colombo branch'
  },
  {
    id: 6,
    name: 'Whipping Cream',
    ...
    unit: 'liters',
    costPerUnit: 8.50,
    supplier: 'Dairy Best Colombo',
    lastRestocked: '2024-01-05',
    status: 'critical',
    description: 'Fresh whipping cream for cakes and desserts'
  },
  {
    id: 7,
    name: 'Baking Paper',
    ...
    unit: 'rolls',
    costPerUnit: 5.00,
    supplier: 'Colombo Kitchenware',
    lastRestocked: '2024-01-13',
    status: 'good',
    description: 'Non-stick baking paper rolls'
  },
  {
    id: 8,
    ...
    unit: 'sets',
    costPerUnit: 16.00,
    supplier: 'Color Lanka',
    lastRestocked: '2024-01-08',
    status: 'low',
    description: 'Professional food coloring gel set for cakes'
  }
];
